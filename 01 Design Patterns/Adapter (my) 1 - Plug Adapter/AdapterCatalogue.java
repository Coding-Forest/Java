...
public class AdapterCatalogue {
    ...
    public String[] searchCountry(String countryName) {
        ...
        for (String[] country : adapterCatalogue) {
            if (country[0].contains(countryName)) {
                theCountry = country;
            }
        }
        return theCountry;
    ...
    String[][] adapterCatalogue = {
            ...
            {"Mongolia", "C / F (note: most sockets in Mongolia are universal ones", "which accept either types A / C", "or types"},
